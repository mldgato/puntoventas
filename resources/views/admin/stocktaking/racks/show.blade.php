...
@section('content_header')
    <div class="row">
        <div class="col">
            <h1><i class="fas fa-cubes"></i> <span class="text-danger">{{ $rack->name }}</span> - <span
                    class="text-success">{{ $rack->warehouse->name }}</span></h1>
        </div>
        <div class="col">
            <div class="d-flex justify-content-end">
                <a href="{{ route('admin.stocktaking.racks.index') }}" class="btn btn-outline-warning btn-lg"
