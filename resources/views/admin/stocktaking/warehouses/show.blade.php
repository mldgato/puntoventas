...
@section('content_header')
    <div class="row">
        <div class="col">
            <h1><i class="fas fa-warehouse"></i> <span class="text-danger">{{ $warehouse->name }}</span></h1>
        </div>
        <div class="col">
            <div class="d-flex justify-content-end">
                <a href="{{ route('admin.stocktaking.warehouses.index') }}" class="btn btn-outline-warning btn-lg"
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="form-control">{{ $warehouse->address }}</div>
                        </div>
                    </div>
                </div>
            </div>
