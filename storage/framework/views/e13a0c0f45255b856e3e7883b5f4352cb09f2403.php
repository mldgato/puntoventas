...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="<?php echo e($identificador); ?>">Imagen:</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
...
<?php /**PATH C:\xampp\htdocs\puntoventas\resources\views/livewire/admin/stocktaking/products/update-product.blade.php ENDPATH**/ ?>